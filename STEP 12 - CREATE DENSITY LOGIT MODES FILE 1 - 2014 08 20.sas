/*STEP 12 EVENT HISTORY ANLAYSIS FILE 1;
...
PROC SORT DATA = PSIDDL&SY..&PA._&SY._DL_A ;
BY ER30001 ER30002;
RUN;

DATA PSIDDL&SY..&PA._&SY._DL_A;
SET PSIDDL&SY..&PA._&SY._DL_A;
/*REMOVE LATINOS*/
IF ER30001 < 7000;
...
DATA PSIDDL&SY..&PA._&SY._DL_FILE1 
...
MERGE PSIDDL&SY..&PA._&SY._DL_A (IN = A) PSIDLT&SY..COVARIATESAT&SY (KEEP = ER30001 ER30002 SEX INDIVRACE RACE RACEA EDUC);
BY ER30001 ER30002;
IF A = 1;
...
LABEL HYBRID_CALCULATEDAGE  = "Computed Age of R derived using the expression SURVEYYAR - HYBRID_INDIVYEAROFBIRTH";
...
PROC EXPORT DATA= PSIDDL&SY..&PA._&SY._DL_FILE1  
            OUTFILE= "U:\1Projects\PSID\WAVE37\DENSITYLOGIT&SY\&PA._&SY._DL_FILE1.sav" 
            DBMS=SPSS REPLACE;
RUN;
...
DATA PSIDDL&SY..&PA._&SY._DL_FILE1_FULL ;
MERGE PSIDDL&SY..&PA._&SY._DL_A (IN = A) PSIDLT&SY..COVARIATESAT&SY (KEEP = ER30001 ER30002 SEX INDIVRACE RACE RACEA EDUC);
BY ER30001 ER30002;
IF A = 1;
LABEL EDUC = "Education of Respondent at Age 25";
...
PROC EXPORT DATA= PSIDDL&SY..&PA._&SY._DL_FILE1_FULL   
            OUTFILE= "U:\1Projects\PSID\WAVE37\DENSITYLOGIT&SY\&PA._&SY._DL_FILE1_FULL.sav" 
            DBMS=SPSS REPLACE;
RUN;
